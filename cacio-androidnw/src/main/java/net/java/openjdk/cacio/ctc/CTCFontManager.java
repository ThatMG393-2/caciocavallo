 ...
 */
public class CTCFontManager extends SunFontManager {
    ...
    protected FontConfiguration createFontConfiguration() {
        CTCFontConfiguration fcFontConfig = new CTCFontConfiguration(this);
    ...
    public FontConfiguration createFontConfiguration(boolean preferLocaleFonts,
        ...
        CTCFontConfiguration fcFontConfig =
            new CTCFontConfiguration(this, preferLocaleFonts, preferPropFonts);
        if (fcFontConfig.init()) {
            return fcFontConfig;
        } else {
            throw new InternalError("failed to initialize fontconfig");
    ...
    /* native */ String getFontPathNative(boolean noType1Fonts, boolean isX11GE) {
        return System.getProperty("user.home") + "/.java/fonts";
    }
